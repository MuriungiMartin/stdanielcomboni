    ...
    <footer>
      <div className="flex flex-col md:flex-row justify-between text-white p-4 md:p-12 bg-gradient-to-b from-black to-slate-800">
        <div className="mb-4 md:mb-0">
          <span className="flex items-center justify-center gap-8 pb-8">
            <img
              src={logoImage}
              alt="Church Logo"
          ...
          <ul className="flex items-start justify-center gap-8  text-[18]">
        ...
        <div className="mb-4 md:mb-0">
          <h1 className="flex items-center justify-center gap-8 text-2xl font-bold mb-4">
            Contact
          </h1>

          <ul className="flex items-center justify-center gap-8 text-[18]">
            <li className="hover:text-fuchsia-600 hover:border-fuchsia-600 cursor-pointer">
        ...
        <div>
          <div className="mb-4 md:mb-0 lg:mr-16">
            <h1 className="flex items-center justify-center gap-8 text-2xl font-bold mb-4 ">Quick Links</h1>
            <ul className="flex items-start justify-center gap-8 text-[18]">
              <li className="hover:text-fuchsia-600 hover:border-fuchsia-600 cursor-pointer">
                Communications
              </li>
      ...
      <div className="flex flex-col md:flex-row items-center justify-center bg-black text-white p-6">
        <p className="text-center text-sm mt-8 md:mt-0 md:mr-8">
          © 2024 St Daniel Comboni Parish. All Rights Reserved.
        </p>
        {/*powered by zegen*/}
        <p className="text-center text-sm mt-8 md:mt-0 md:ml-8">
          Developed by{" "}
          <a
